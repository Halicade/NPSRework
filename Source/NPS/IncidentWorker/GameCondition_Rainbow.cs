...
public class GameCondition_Rainbow : GameCondition
{
    ...
    public override SkyTarget? SkyTarget(Map map) {
        ...
        return new SkyTarget(
            colorSet: new SkyColorSet(Color.Lerp(Color.white, currentColor, SkyColorStrength) * Brightness(map),
                new Color(0.92f, 0.92f, 0.92f), Color.Lerp(Color.white, currentColor, OverlayColorStrength) * Brightness(map), 1f),
            glow: Mathf.Max(GenCelestial.CurCelestialSunGlow(map), Glow), lightsourceShineSize: 1f,
